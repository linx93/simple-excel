...
type Student struct {
	Hobby  Hobby  `json:"hobby" xlsx:"head:爱好;headCol:2;ignore:true"` //爱好
...
type Sub struct {
	CompSub  CompSub  `json:"compSub" xlsx:"head:理科;ignore:true"` //Comprehensive subjects 综合科目 理科
	Chinese  string   `json:"chinese" xlsx:"head:语文;ignore:true"` //
...
type CompSub1 struct {
	Politics  string `json:"politics" xlsx:"head:政治;ignore:true"` //政治
...
type Choose struct {
	ChooseA       string              `json:"chooseA" xlsx:"head:选修A;ignore:true"`
...
type ChooseModernHistory struct {
	ModernChineseHistory string `json:"modernChineseHistory" xlsx:"head:中国近代史;ignore:true"`
